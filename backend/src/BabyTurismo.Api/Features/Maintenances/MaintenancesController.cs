...
using BabyTurismo.Application.Fleet.Maintenance.Commands;
using BabyTurismo.Application.Fleet.Maintenance.Queries;
using BabyTurismo.Domain.Fleet.Maintenance;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace BabyTurismo.Api.Features.Maintenances;
...
public sealed class MaintenancesController : BaseController
{
    ...
    {
        if (id != command.Id)
            return BadRequest(BabyTurismo.Shared.Results.Error.Validation("Maintenance.IdMismatch", "The ID in the URL must match the ID in the body."));
