...
using BabyTurismo.Application.Inventory.Commands;
using BabyTurismo.Application.Inventory.Queries;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace BabyTurismo.Api.Features.Inventory;
...
public sealed class CategoriesController : BaseController
{
    ...
    {
        if (id != command.Id)
            return BadRequest(BabyTurismo.Shared.Results.Error.Validation("Category.IdMismatch", "The ID in the URL must match the ID in the body."));
