...
using BabyTurismo.Application.Fleet.Vehicles.Queries;
using BabyTurismo.Application.Operations.Checklists.Commands;
using BabyTurismo.Application.Operations.Checklists.Queries;
using BabyTurismo.Application.Operations.Drivers.Queries;
using BabyTurismo.Application.Operations.Trips.Commands;
using BabyTurismo.Application.Operations.Trips.Queries;
using BabyTurismo.Application.VehicleIssues.Commands;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace BabyTurismo.Api.Features.Driver;
