...
public sealed class CreateDriverCommandHandler : IRequestHandler<CreateDriverCommand, Result<Guid>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var emailResult = BabyTurismo.Domain.Common.ValueObjects.Email.Create(request.Email);
