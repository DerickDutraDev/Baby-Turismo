    ...
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        try
        {
            ...
            if (!await context.Tenants.AnyAsync())
            {
                ...
                var sysAdminEmail = configuration["Seed:SystemAdminEmail"] ?? "admin@babyturismo.io";
                ...
                // 1. Create BabyTurismo Platform Tenant (System Admin)
                var platformTenant = Tenant.Create("BabyTurismo Platform", "babyturismo");
